    ...
    <>
      ...
      <ScrollReveal>
        <section className="py-24 bg-surface-0 relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Meet the founder</h2>
            </div>
                ...
                <div className="p-8 md:p-12 rounded-3xl bg-surface-50 border border-surface-200 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-10">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-3">
                      <span className="px-3 py-1.5 rounded-lg bg-surface-100 border border-surface-200 text-neutral-300 text-xs font-medium">
